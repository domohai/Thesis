\section{Temporal and Event Extensions to OCL}
...
% For more details about TOCL's formal semantics, grammar specification, and integration with OCL, we refer readers to the original work by Ziemann and Gogolla \cite{TOCL}. Their comprehensive formalization establishes the theoretical foundation upon which we build our event extensions.
