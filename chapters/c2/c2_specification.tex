...
before and after execution. However, this approach remains fundamentally 
state-centric and struggles with directly expressing event-based properties, such 
as counting specific operation invocations.
